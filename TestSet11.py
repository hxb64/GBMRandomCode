...
chunks = pd.read_csv('/Users/Hamza/Downloads/used_cars_data.csv', chunksize=chunk_size, low_memory=False)
...
top_n = 28  # Set the number of top features to display
...
small_model = lgb.LGBMRegressor(n_estimators=int(1))
...
for i in range(num_noise_vectors):
    x_valid_noisy = x_valid_normalized + np.random.normal(0, 0.01, x_valid_normalized.shape)  # Adding Gaussian noise
